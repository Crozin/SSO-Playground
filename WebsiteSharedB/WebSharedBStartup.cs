...
[assembly: OwinStartup(typeof(WebsiteSharedB.WebsiteSharedBStartup))]

namespace WebsiteSharedB
{
    public class WebsiteSharedBStartup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            app.UseOpenIdConnectAuthentication(new OpenIdConnectAuthenticationOptions
            {
                ...
                RedirectUri = "http://website-b.shared.sso.com/",
                ResponseType = "id_token",
                SignInAsAuthenticationType = "Cookies",
                Scope = "openid profile",
                UseTokenLifetime = true,
                PostLogoutRedirectUri = "http://website-b.shared.sso.com/",
